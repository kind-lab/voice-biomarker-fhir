Instance: GeneralAcousticTasksQuestionnaire
InstanceOf: VbaiQuestionnaire
Usage: #example
Title: "GeneralAcousticTasksQuestionnaire"
Description: "GeneralAcousticTasks Questionnaire"

* date = 2023-10-05
* title = "General Acoustic Tasks"
* status = #active
...
* item[=].linkId = "Maximum phonation time:"
* item[=].text = " Say /e/ (max. phonation time ): 'Using your normal voice, take a deep breath and say /e/' until you run completely out of air (click stop when you run out of air)'. (need to ask for this task twice!)."
* item[=].type = #attachment

* item[+].prefix = "1.5.1 Task 3" 
* item[=].linkId = "Glides"
* item[=].text = "Using the sound “e”, glide from your lowest pitch possible to the highest pitch possible. Rest, take a breath and then glide from your highest pitch possible to the lowest pitch possible"
* item[=].type = #attachment

* item[+].prefix = "1.5.1 Task 4" 
* item[=].linkId = "Rainbow passage"
...
* item[+].prefix = "1.5.1 Task 5" 
* item[=].linkId = "Cape-V Sentences"
