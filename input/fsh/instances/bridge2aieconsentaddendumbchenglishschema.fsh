...
* version = "1.4.0"
* status = #active
* date = "2024-03-26T20:05:27Z"
* publisher = "KinD Lab"
* contact.name = "KinD Lab"
* contact.telecom.system = #url
* contact.telecom.value = "http://fhir.kindlab.sickkids.ca"
* item[0].linkId = "consent_bch_p1"
* item[=].type = #string
* item[=].text = "consent_bch_p1"
* item[+].linkId = "consent_bch_p2"
* item[=].type = #string
* item[=].text = "consent_bch_p2"
* item[+].linkId = "consent_bch_p3"
* item[=].type = #string
* item[=].text = "consent_bch_p3"
* item[+].linkId = "consent_bch_p4"
* item[=].type = #string
* item[=].text = "consent_bch_p4"
* item[+].linkId = "consent_bch_statement"
* item[=].type = #string
...
* item[+].linkId = "consent_wcm_permission_1_bch"
* item[=].type = #choice
...
* item[+].linkId = "consent_wcm_permission_2_bch"
* item[=].type = #choice
...
* item[=].answerOption[0].valueString = "Yes"
* item[=].answerOption[+].valueString = "No"
* item[+].linkId = "consent_wcm_statement_2_bch"
* item[=].type = #string
...
* item[+].linkId = "consent_wcm_signature_bch"
* item[=].type = #string
...
* item[+].linkId = "consent_wcm_date_bch"
* item[=].type = #string
* item[=].text = "consent_wcm_date_bch"