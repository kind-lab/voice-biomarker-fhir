Instance: MoodAcousticTasksQuestionnaire
InstanceOf: VbaiQuestionnaire
Usage: #example
Title: "MoodAcousticTasksQuestionnaire"
Description: "MoodAcousticTasks Questionnaire"

* date = 2023-10-05
* title = "Mood Acoustic Tasks"
* status = #active

* item[0].prefix = "1.8.1" 
* item[=].linkId = "Task 1: Animal Fluency"
* item[=].text = "Say as many animals as you can in one minute, avoid repeating words (continue trying until time is up)” - need a timer with 1 minute here "
* item[=].type = #attachment

* item[+].prefix = "1.8.2" 
* item[=].linkId = "Task 2: Open response questions"
