Instance: PedsAcousticTasksQuestionnaire
InstanceOf: Questionnaire
Usage: #example
Title: "PedsAcousticTasksQuestionnaire"
Description: "PedsAcousticTasks Questionnaire"

* date = 2023-10-05
* title = "Peds Acoustic Tasks"
* status = #active

* item[0].prefix = "1.8.2 Task 1" 
* item[=].linkId = "Task 1 a: Spontaneous Conversations:"
* item[=].text = "As we look at this book together, tell me what you see. Task 1 b: Spontaneous Conversations Describe your favorite thing to do on weekends."
* item[=].type = #attachment

* item[+].prefix = "1.8.2 Task 2" 
* item[=].linkId = "Make some long sounds"
* item[=].text = "For this task we want you to make some long sounds – not too loud. Begin by saying ‘ahhhh’.We’re going to do this task three times. Take a break after each attempt. Next say the sound ‘eeee’ as steady as you can. We’ll do this sound three times as wel"
* item[=].type = #attachment
